...
<script>
  ...
  import { edit } from '../../../../api/DeliveryStandardAPI'
    ...
    watch: {
      rowData: {
        ...
        handler(value){
          ...
          this.ruleForm.invalidatemark = value.invalidatemark ? 1:0
          this.ruleForm.maxweight = value.maxweight
          this.ruleForm.minweight = value.minweight
